...
<div class="thank-you text-center">
	<img src="<?= base_url('assets/images/thank-kappali.png') ?>" alt="thank you"><br><br>
	<h6>Thank for choosing Kappali. Your request has been saved. After getting redeem request payment will be done within 3 to 5 working days</h6><br>
